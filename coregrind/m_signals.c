...
#elif defined(VGO_darwin) || defined(VGO_solaris) || defined(VGO_freebsd)|| defined(VGO_dragonfly)
...
#     if !defined(VGP_ppc32_linux) && !defined(VGP_mips32_linux) && \
         ...
         !defined(VGO_solaris) && !defined(VGO_freebsd) && !defined(VGO_dragonfly)
...
#     if !defined(VGP_riscv64_linux) && !defined(VGO_darwin) && \
         !defined(VGO_freebsd) && !defined(VGO_solaris)&& !defined(VGO_dragonfly)
